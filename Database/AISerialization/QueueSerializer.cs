...
public static class QueueSerializer {
    ...
    public static string PostCalcs(in MiniQueue q) {
        ...
        Console.ForegroundColor = ConsoleColor.White;
            ...
            const int    trunc = 15;
            return ($"{z_scores[0]},{z_scores[1]},{z_scores[2]},{t1_bias}," +
                    $"{z_scores[3]},{z_scores[4]},{z_scores[5]},{t2_bias}");
    ...
    private static void GetBiases(ref Int64 t1_out, ref Int64 t2_out, ref List<Int64> z_scores) {
